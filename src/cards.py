class Card:
    ...
    def createCardLibrary(cls):
        cls.cardLibrary={
            ...
            'Knight': Troop('Knight', 3, 'assets/knight.png', 'assets/knight_sprite.png', 1766, 202, 1, 1.5, 'ground', 'medium'),
            'Mini-Pekka':Troop('Mini-Pekka', 4, 'assets/mini-pekka.png', 'assets/mini-pekka_sprite.png', 1361, 720, 1.6, 1, 'ground', 'fast'),
